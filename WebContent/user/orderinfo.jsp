...
<!--文件尾开始-->
		...
		<tr>
			...
			<td width="60%" class="tablebody1">支付宝</td>
		</tr>
		</table>
		<br>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/productDetail?id=${line.book.id}" target="_blank">${line.book.name }</a></td>
